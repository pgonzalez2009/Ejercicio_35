...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (adaptadorbluetooth == null) {
            ...
            //SOPORTA BLUETOOTH.
            Toast.makeText(getApplicationContext(), "El dispositivo Bluetooth no está disponible", 5);
        }
    ...
    public void habilitarBluetooth() {
        if (!adaptadorbluetooth.isEnabled()) {
            ...
            Toast.makeText(getApplicationContext(), "El dispositivo BLUETOOTH YA ESTÁ HABILITADO", 7);
        }
    }
...
//INDICAMOS AL USUARIO QUE SE HA HABILITADO EL BLUETOOTH
                    Toast.makeText(getApplicationContext(),
                            "El dispositivo Bluetooth está HABILITADO", 7);
